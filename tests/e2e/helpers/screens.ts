...
export const MOCKUP_SCREENS: MockupScreen[] = [
  ...
  { id: 'template-designer', name: 'PAGE: TEMPLATE DESIGNER', path: '/templates/designer', heading: /Template Designer/i, auth: 'staff' },
  ...
  { id: 'admin-panel', name: 'PAGE: SUPER ADMIN CONTROL PANEL', path: '/admin', heading: /Super Admin Control Panel/i, auth: 'staff' },
  ...
  { id: 'reports', name: 'PAGE: REPORTS', path: '/reports', heading: /Reports/i, auth: 'staff' },
