@php
  // Standard Invoice — compact modern layout. Header shares business,
  // customer, vehicle, and invoice meta in one card; complaint/symptoms
  // always sits above the line items, which own most of the page.
...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .company-name { margin: 0 0 3px; font-size: 13.5pt; font-weight: 700; letter-spacing: -0.01em; line-height: 1.2; }
    ...
    .balance-band { margin-top: 5px; background: {{ $ink }}; border-radius: 6px; }
...
<body>
  ...
  @if($sectionVisible('line_items'))
    <table class="lines-table">
      <thead>
        <tr>
          <th style="width:7%;" class="center">Type</th>
  ...
  @if($sectionVisible('totals') || $sectionVisible('footer'))
    <table class="bottom">
      <tr>
        <td width="55%" style="padding-right:24px; vertical-align:top;">
