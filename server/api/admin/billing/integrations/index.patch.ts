  ...
  try {
    ...
    void writeAudit(event, {
      ...
      beforeData: {
        ...
        hasVultrUsername: before.hasVultrUsername,
        hasVultrPassword: before.hasVultrPassword,
        cloudflareEnabled: before.cloudflareEnabled,
        cloudflareAccountId: before.cloudflareAccountId,
        hasCloudflareApiToken: before.hasCloudflareApiToken,
        hasCloudflareUsername: before.hasCloudflareUsername,
        hasCloudflarePassword: before.hasCloudflarePassword,
        openrouterBillingEnabled: before.openrouterBillingEnabled,
        hasOpenrouterManagementKey: before.hasOpenrouterManagementKey,
        hasOpenrouterUsername: before.hasOpenrouterUsername,
        hasOpenrouterPassword: before.hasOpenrouterPassword,
      },
      afterData: {
        ...
        hasVultrUsername: settings.hasVultrUsername,
        hasVultrPassword: settings.hasVultrPassword,
        cloudflareEnabled: settings.cloudflareEnabled,
        cloudflareAccountId: settings.cloudflareAccountId,
        hasCloudflareApiToken: settings.hasCloudflareApiToken,
        hasCloudflareUsername: settings.hasCloudflareUsername,
        hasCloudflarePassword: settings.hasCloudflarePassword,
        openrouterBillingEnabled: settings.openrouterBillingEnabled,
        hasOpenrouterManagementKey: settings.hasOpenrouterManagementKey,
        hasOpenrouterUsername: settings.hasOpenrouterUsername,
        hasOpenrouterPassword: settings.hasOpenrouterPassword,
      },
