        ...
        <div class="card">
          ...
          <div class="cbody">
            <p style="font-size:13px; color:#475569; margin:0 0 14px;">
              PDF generation uses the <b>laravel-pdf</b> container (Laravel Blade + <b>barryvdh/laravel-dompdf</b>). The <b>pdf-worker</b> queue processor starts automatically with Docker Compose. No extra configuration is required for most deployments.
            </p>
