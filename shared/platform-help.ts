...
export const HELP_ANSWERS: HelpAnswer[] = [
  ...
  { keys: ['email template', 'email templates'], text: 'Edit outbound email copy from <b>Control Panel → Notifications → Open email template editor</b>. Save a template, then set it active to override the system default.' },
