...
export const TRAINING_CATALOG: TrainingCatalogModule[] = [
        ...
        steps: [
          ...
          },
          {
            ...
            callouts: [
              ...
              { label: 'Invoice and due dates', detail: 'These carry onto the invoice when the log is sent.' },
            ],
          },
          {
            type: 'content',
            title: 'Capture with photos',
            body: 'Photograph the paper service log sheet and note the customer complaint. The photo course walks through the full wizard.',
            tips: ['Include the full page — do not crop off totals or unit numbers.', 'Multiple pages are fine; add another photo for each sheet.'],
          },
          {
            type: 'interactive',
            title: 'Hand it off',
          ...
          },
          {
            ...
            items: [
              ...
              { label: 'Symptoms and photos captured', detail: 'Complaint text plus clear sheet photos.' },
  ...
  },
  {
    ...
    description: 'Build a complete practice service log — customer, vehicle, invoice dates, symptoms, and photos.',
        ...
        steps: [
          {
            ...
            body: 'You will walk through the **New service log** wizard: customer, vehicle, invoice dates, symptoms, photos, then submit.',
            icon: 'camera',
          },
          {
            type: 'content',
            title: 'Photo tips',
            body: 'In production, photograph the paper service log sheet. Training uses a placeholder so you do not need a camera.',
            tips: [
              'Include the full page — do not crop off totals or unit numbers.',
              'Multiple pages are fine; tap the photo zone again for each sheet.',
              'Invoice date and due date carry onto the invoice when the log is sent.',
            ],
          },
          {
            type: 'practice',
          ...
          {
            type: 'practice',
            title: 'Step 3 — Invoice dates',
            body: 'Enter the invoice date and due date.',
            practiceId: 'sl-dates',
          },
          {
            type: 'practice',
            title: 'Step 4 — Symptoms & photos',
            body: 'Enter the customer complaint, then tap **Add practice photo**.',
            practiceId: 'sl-log-photo',
          },
          {
            type: 'practice',
            title: 'Step 5 — Review & submit',
            body: 'Confirm the details, then submit the practice log.',
          ...
          },
          {
            ...
            body: 'You built a full practice log with a photo. On the job: Service Logs → New service log → customer, vehicle, dates, symptoms, photos, submit.',
          },
        ],
      },
    ],
        ...
        steps: [
          ...
          },
          {
            ...
            items: [
              ...
              { label: 'Invoice date and due date entered', detail: 'Step 3 — Dates' },
              { label: 'Symptoms and photos captured', detail: 'Step 4 — Log' },
              { label: 'Reviewed on step 5', detail: 'Submit log only when accurate' },
            ],
          },
          {
            type: 'complete',
            title: 'Submission flow understood',
            body: 'Always double-check customer, vehicle, dates, symptoms, and photos before tapping Submit log.',
          },
        ],
      },
    ],
