...
export const APP_KNOWLEDGE_DOCS: AppKnowledgeDoc[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'Mutating SMS actions always preview first; staff reply YES to send or Back to stop. Never tell staff to text CANCEL/STOP — those are carrier unsubscribe keywords. Web help stays read-only.',
