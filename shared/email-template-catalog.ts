...
export const EMAIL_TEMPLATE_CATALOG: EmailTemplateDefinition[] = [
  ...
  },
  {
    ...
    description: 'Morning digest for admins and managers: outstanding invoices, billing snapshot, and Susan action items.',
    audience: 'staff',
    group: 'system',
    defaults: {
      ...
      lead: 'Here\'s today\'s receivables snapshot and ops billing outlook for managers and admins.',
      noteTitle: 'From Susan',
      noteBody: 'Review outstanding invoices for reconciliation, then clear any ops bills that are due.',
