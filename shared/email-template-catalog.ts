...
export const EMAIL_TEMPLATE_CATALOG: EmailTemplateDefinition[] = [
  ...
  },
  {
    ...
    description: 'Admin-issued temporary password for an existing staff account.',
    audience: 'staff',
    group: 'security',
    defaults: {
      ...
      lead: 'An administrator reset your {{brandName}} staff password. Sign in with the temporary password below, then choose a new one.',
      noteTitle: 'Next step',
      noteBody: 'Use the temporary password to sign in. You will be locked to a password form until you create a new password. If you did not expect this, contact your administrator.',
      primaryActionLabel: 'Sign in to staff workspace',
      htmlSource: '',
    },
    variables: [
  ...
  },
  {
    ...
    group: 'security',
    defaults: {
      subject: 'Notification channel updated',
      eyebrow: '',
      headline: 'Notification channel updated',
      lead: '{{leadMessage}}',
      noteTitle: 'Change it anytime',
      noteBody: 'If you prefer a different channel, you can update this on the My Account page.',
      primaryActionLabel: 'Open My Account',
      htmlSource: '',
    },
    variables: [
      v('name', 'Name'),
    ...
    sampleVars: {
      ...
      brandName: 'Devon On Site Repairs',
      channelLabel: 'Text',
      leadMessage: 'The system has changed your notification channel to Text. Quicker, cleaner notifications without cluttering your email inbox. If you prefer emails, you can change this on the My Account page.',
