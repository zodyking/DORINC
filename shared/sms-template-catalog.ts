  ...
  },
  {
    ...
    defaults: {
      body: [
        ...
        'Hi {{name}},',
        '',
        'Save the Dorinc contact',
        '',
        'Add Dorinc to your phone so you can reach Susan AI on this number anytime.',
        '',
        'Contact name',
        '{{contactName}}',
        '',
        ...
        '{{quoPhone}}',
        '',
        'Tap to save (includes the Dorinc logo):',
        '{{contactUrl}}',
      ].join('\n'),
    },
    variables: [
      ...
      { key: 'quoPhone', label: 'Quo phone number' },
